...
| -------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Product positioning              | YesFi is the first all-asset derivatives platform. It brings Flash Options and perpetuals to crypto, FX, stocks, commodities, and more.                                                                                                                                                                                                        |
| Core products                    | **Flash Options** turn professional strategies into intuitive products with a few clear inputs. No complex strike prices or traditional options jargon are required. **AI Signals** present trade ideas as one-tap positions. Opt-in, **Perps**-based insurance can cap downside with **Zero Loss** or enhance outcomes with **Double Profit** |
...
* [**Flash Options**](flash-options/) — an introduction to the seven Flash Options modes
