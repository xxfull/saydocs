...
YesFi is the first all-asset derivatives platform bringing Flash Options and perps to crypto, FX, stocks, commodities, and more.

\
Instead of exposing users to complex strike prices and traditional options jargon, YesFi turns pro-grade Flash Options strategies into intuitive products built around a few clear inputs — **Flash Options**. On the perp side, **AI Signals** surface trade ideas as one-tap positions, while opt-in, perp-based **Insurance** helps users cap downside (**Zero Loss**) or enhance outcomes (**Double Profit**).
...
* [**Beats**](../flash-options/beats.md)**:** Predict whether an asset price will rise or fall. A correct call receives the quoted payout.
* [**Combo**](../flash-options/combo.md)**:** Combine bullish or bearish calls for three assets. All three must be correct to win.
* [**Moves**](../flash-options/moves.md)**:** Predict the size of an asset's high-to-low price range. Direction does not matter.
* [**Pair**](../flash-options/pair.md)**:** Predict which asset in a selected pair will outperform the other.
* [**Range**](../flash-options/range.md)**:** Predict whether the settlement price will remain within a selected range.
* [**Steps**](../flash-options/steps.md)**:** Predict how far the price will rise. Settlement uses the highest tier reached.
* [**Trend**](../flash-options/trend.md)**:** Predict an asset's direction and required move. Higher movement tiers offer higher payouts.
...
The AI assistant helps you explore markets through chat. It uses market data, trading signals, and your historical behavior to provide trade ideas, risk context, position-sizing guidance, and Flash Options comparisons. Describe your market view, rough margin size, and TP/SL intent in plain language — text or voice — to receive relevant analysis and explanations.
